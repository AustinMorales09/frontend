...
//image imports
import Partypeople from './img/Partypeople.avif';
import Roebling from './img/Roebling.jpeg';
import Arcade from './img/Arcade.jpg';
import Music from './img/Music.jpg';
import Sundry from './img/Sundry.jpg';
import Jacks from './img/Jacks.jpg';
import Corkopolis from './img/Corkopolis.jpg';
import Tokyo from './img/Tokyo.jpg';
import Establishment from './img/Establishment.jpg';
import Tillies from './img/Tillies.jpg';
import Anjou from './img/Anjou.png';
  ...
  const handleShow = () => setShow(true);
    ...
    return (
      ...
      <div>
            ...
            <Modal.Dialog>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Mon-Wed: 4p-12:30a <br /> Thurs: 4p-1:30a <br /> Fri: 4p-2:30a <br /> Sat: 12p-2:30a <br /> Sun: 12p-12:30a</li>
            ...
            <Modal.Dialog>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Mon-Fri: 10a-5p <br /> Sat: 10a-2p</li>
        ...
        <br />
        <img src={Sundry} alt="Sundry" />
        <br />
        <p>The atmosphere in this bar calls for a nice dinner with friends; it's considered an upscale cocktail bar, and they definitely fit the description!  They serve delicious adult beverages, and they do so with style.  They're a rustic but charming place, and their drinks are made and served just as fancy as the dècor.  This is a great place to relax and have a good drink while having some fun.</p>
        <div className="modal">
            <Modal.Dialog>
                <Modal.Header closeButton>
                    <Modal.Title>Sundry and Vice</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Tues-Thurs: 4p-1a <br /> Fri: 4p-2a <br /> Sat: 2p-2a <br /> Sun: 2p-12a</li>
        ...
        <div className="modal">
            <Modal.Dialog>
                <Modal.Header closeButton>
                    <Modal.Title>Jim and Jack's on the River</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Mon-Thurs: 9a-1a <br /> Fri, Sat: 9a-2:30a <br /> Sun: 9a-1a</li>
        ...
        <br />
        <img src={Corkopolis} alt="Corkopolis" />
        <br />
        <p>Corkopolis has the most delicious wine around; they're a sort of fancy wine bar, and they carry local and imported wine.  They have a great variety of reds and whites that'll make the tastebuds sing.  They even offer beer and champagne too!  From Vilmart et Cie Coeur de Cuvée champagne to Rhinegeist Night Glow Fruited Sour beer, there's a tasty choice for everyone.</p>
        <div className="modal">
            <Modal.Dialog>
                <Modal.Header closeButton>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Tues-Thurs: 12p-8p <br /> Fri, Sat: 12p-9p</li>
            ...
            <Modal.Dialog>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Tues-Thurs: 6p-12a <br /> Fri: 6p-2a <br /> Sat: 4p-2a <br /> Sun: 6p-12a</li>
        ...
        <br />
        <p>If you love to get some fresh air as you enjoy your meal, they offer outside seating in this beautiful patio area, and they have lights and fireplaces in the middle of the tables for the nighttime.  It's a beautiful place to enjoy a nice meal, or have some drinks.  They serve well-mixed adult beverages, as well as bar snack food, like salads, sandwhiches, and burgers.  There's also weekly specials they offer for their food and drinks.  The service is outstanding, and the atmosphere is amazing!  The Establishment is a great time for any occassion.</p>
        <div className="modal">
            <Modal.Dialog>
                <Modal.Header closeButton>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Mon-Fri: 11:30a-2:30a <br /> Sat, Sun: 11a-2:30a</li>
            ...
            <Modal.Dialog>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Mon, Tues: 5p-12a <br /> Wed-Fri: 4p-2a <br /> Sat: 6p-2a <br /> Sun: 2-8p</li>
        ...
        <br />
        <img src={Anjou} alt="Anjou" />
        <br />
        <p>They're an upscale cocktail bar, and their drinks are out of this world!  Many of the drinks they offer are served with a garnish for presentation (like mint leaves or cucumber), and they give you a decent pour.  They have deals on their bottles of wine as well; they offer them half-priced from open to close every day!  Cocktails, beer, and wine, there's something for everyone to try.  They also offer cheese and charcuterie boards to pair with the beverages.  Anjou definitely hits the mark for fancy!</p>
        <div className="modal">
            <Modal.Dialog>
                <Modal.Header closeButton>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: Tues-Thurs: 3-11p <br /> Fri, Sat: 3p-12a</li>
